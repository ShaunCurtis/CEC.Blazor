...
{
    public abstract class BaseServerDataService<TRecord> : BaseDataService<TRecord>, IDataService<TRecord> where TRecord : new()
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual WeatherForecastDbContext GetContext()
        {
        ...
        protected async Task<DbTaskResult> RunStoredProcedure(TRecord record, SPType spType)
        {
            ...
            if (await this.GetContext().ExecStoredProcAsync(spname, parms))
            {
